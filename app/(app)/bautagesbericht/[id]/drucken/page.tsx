    ...
    <div className="print-page bg-white p-8 max-w-[210mm] mx-auto text-[11px] text-foreground leading-relaxed">
      ...
      {(entry.incidents || entry.defects) && (
        <div className="mb-6">
          ...
          {entry.incidents && <p className="mb-1"><span className="font-semibold">Vorfaelle:</span> {entry.incidents}</p>}
          {entry.defects && <p className="mb-1"><span className="font-semibold">Maengel:</span> {entry.defects}</p>}
        </div>
      )}
